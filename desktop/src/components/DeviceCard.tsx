    ...
    <motion.div initial={{ y: 30, opacity: 0, filter: 'blur(6px)' }}
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="w-16 h-16 rounded-lg shadow-lg shadow-black/50 bg-gradient-to-b from-zinc-500 /20 to-zinc-600 /20   flex items-center justify-center text-4xl">
            
          </div>
          <div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="p-3 rounded-2xl glass-panel-card ">
